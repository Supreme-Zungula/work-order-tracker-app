      ...
      <div class="flex min-h-full items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-lg bg-white rounded-lg shadow-xl transform transition-all">
          ...
          <form @submit.prevent="handleSubmit" class="p-4 space-y-4">
            <div v-if="error" class="p-3 text-sm text-red-600 bg-red-50 border border-red-200 rounded-md" role="alert">
              {{ error }}
            </div>
            ...
            <div>
              <label for="assignedTo" class="block text-sm font-medium text-gray-700 mb-1">Assigned To <span class="text-red-500">*</span></label>
              <input
                id="assignedTo"
